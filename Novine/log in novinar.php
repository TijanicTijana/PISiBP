<?php
	...
	include("classes/log in novinar.php");
...
<html>
	<head>
	    <title>Novine | Log in as Novinar</title>
	</head>
	<style>
		#bar{
			height: 100px;
	...
	<body style="font-family: tahoma; background-color: #E8F6F3; ">
	    ...
	    <div id="login_bar">
	    	...
	    	<form method="post" action="log in.php">
	    		...
	    		Log in as Novinar <br><br>
		    	<input name="Novinar_Email" value="<?php echo $Novinar_Email ?>" type="text" id="text" placeholder="Email"><br><br>
				<input name="Novinar_Sifra" value="<?php echo $Novinar_Email ?>" type="Password" id="text" placeholder="Password"><br><br>
